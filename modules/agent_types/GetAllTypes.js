...
var getAllTypes = express.Router();
//Create a GET Mapped method to get all the types
getAllTypes.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientObj, db, roles, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection('agent_roles').find().toArray()];
            case 2:
                roles = _a.sent();
                ;
                //validate the result
