...
var getAllArsenal = express.Router();
//Create a GET Mode REST Method on the Module and Pass a Path Param
getAllArsenal.get('/:arsenalType', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientObj, db, type, arsenal, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                type = req.params.arsenalType;
                arsenal = [];
                if (!(type == "all")) return [3 /*break*/, 3];
                return [4 /*yield*/, db.collection('arsenal').find({}).toArray()];
            case 2:
                //If the picked type is all then find all the arsenal
                arsenal = _a.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, db.collection('arsenal').find({ 'type': type }).toArray()];
            case 4:
