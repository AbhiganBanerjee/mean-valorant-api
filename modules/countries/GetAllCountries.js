...
var getAllCountries = express.Router();
//Create a REST Service mapped with GET mode of request to get all the countries
getAllCountries.get('', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientObj, db, countries, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection('countries').find({}).toArray()];
            case 2:
                countries = _a.sent();
                //validate the result
...
//export the module
exports.default = getAllCountries;
