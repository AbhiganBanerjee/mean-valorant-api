...
var getAllMaps = express.Router();
//Create a GET Mapped REST Service to get all the maps and read pathParam
getAllMaps.get('/:mapType', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientObj, mapSites, db, maps, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                mapSites = req.params.mapType;
                db = clientObj.db('ishopdb');
                maps = [{}];
                if (!(mapSites == 'all')) return [3 /*break*/, 3];
                return [4 /*yield*/, db.collection('maps').find({}).toArray()];
            case 2:
                maps = _a.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, db.collection('maps').find({ 'sites': mapSites }).toArray()];
            case 4:
                maps = _a.sent();
                _a.label = 5;
            case 5:
