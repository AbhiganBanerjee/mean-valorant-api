...
var getAllUsers = express.Router();
//Create a GET Mapped REST Method
getAllUsers.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientObj, db, users, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection('reg_users').find({}).toArray()];
            case 2:
                users = _a.sent();
