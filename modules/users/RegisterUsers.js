...
var registerUesrs = express.Router();
//Create a POST Mode request to insert users in DB
registerUesrs.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientObj, db, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection('reg_users').insertOne({
